...
- **The Administrative section's field grid went from 2 columns to 1** — once every _section_ was already stacked vertically, the remaining "boxes side by side" complaint was actually about the individual fields within that one card.
