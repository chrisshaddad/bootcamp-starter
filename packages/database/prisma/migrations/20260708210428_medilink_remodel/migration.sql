/*
  ...
  - The values [ORG_ADMIN,MEMBER] on the enum `UserRole` will be removed. If these variants are still used in the database, this will fail.
...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SUPER_ADMIN', 'INSTITUTION_ADMIN', 'STAFF', 'PROFESSIONAL', 'PATIENT');
