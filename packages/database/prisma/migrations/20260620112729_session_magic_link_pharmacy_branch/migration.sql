...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_pharmacyId_branchId_fkey" FOREIGN KEY ("pharmacyId", "branchId") REFERENCES "pharmacy_branches"("pharmacyId", "id") ON DELETE SET NULL ON UPDATE CASCADE;
