        ...
        <div className="relative">
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-2xl shadow-primary-base/10 sm:p-6">
            ...
            <p className="mt-4 text-sm leading-relaxed text-foreground">
              <span className="font-semibold">Parts &amp; Supplies</span> is
              your biggest cost lever — it&apos;s{' '}
              <span className="font-semibold text-primary-300">38%</span> of
              total expenses and rising faster than revenue. Your tune-up
              service has the strongest contribution margin at{' '}
