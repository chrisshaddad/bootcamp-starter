      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 px-5 pt-16 pb-20 sm:px-8 sm:pt-20 lg:grid-cols-[1.05fr_1fr] lg:gap-10 lg:pt-24 lg:pb-28">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            Margin turns your sales and expenses into real profitability metrics
            — gross and net margin, per-item contribution, break-even — then
            layers on AI insights tied to your actual numbers, not generic
            advice.
          </p>
