...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      {/* Left Panel - Hero Section. Deliberately fixed-dark regardless of
          the light/dark toggle (a branded hero column, not page content). */}
      <div className="relative hidden w-1/2 bg-[#0d0d0e] lg:flex lg:flex-col lg:justify-end">
        {/* Background Image */}
        <div className="relative flex-1">
          <Image
            src="https://images.unsplash.com/photo-1672344048213-76b6e77304bd?auto=format&fit=crop&w=1200&q=80"
            alt="Dumbbell in a gym"
            fill
        ...
        {/* Content Section with brand top border */}
        <div className="flex flex-col gap-6 border-t-[5px] border-primary-base bg-[#0d0d0e] px-12.5 pb-15 pt-10">
          {/* Logo */}
          ...
          <h1 className="text-5xl font-bold leading-[1.2] tracking-[-0.5px] text-white">
            Your whole gym, finally in one place.
          </h1>

          {/* Subtext */}
          <p className="text-lg leading-normal text-white/80">
            Membership, scheduling, and check-ins, all from one dashboard.
          </p>
        </div>
      </div>
      ...
      <div className="relative flex w-full flex-col justify-between lg:w-1/2">
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-12">
          <div className="flex w-full max-w-120 flex-col items-center gap-8">
            ...
            >
              ...
              <Button
                type="submit"
                className="h-14 w-full rounded-[10px] bg-primary-base text-base font-bold leading-normal tracking-[0.3px] text-white hover:bg-primary-base/90 disabled:bg-muted disabled:text-muted-foreground"
        ...
        <footer className="px-6 py-6">
          <div className="flex flex-wrap items-center justify-center gap-2.5 text-sm font-medium leading-[1.6]">
            <span className="text-muted-foreground">
              © {new Date().getFullYear()} Fieldhouse. All rights
              reserved.
            </span>
            <a
              href="/terms"
