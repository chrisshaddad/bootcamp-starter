...
export default function AuditLogsPage() {
  ...
  const { auditLogs, totalPages, isLoading, isValidating, error } =
    useAuditLogs({
      page: currentPage,
      limit: 20,
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {totalPages && totalPages > 1 && (
        <div className="flex items-center justify-between sm:justify-end gap-2 pt-6 border-t border-border">
          <Button
            variant="outline"
            size="sm"
